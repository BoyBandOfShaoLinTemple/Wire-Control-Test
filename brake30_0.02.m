...
h3=plot(time(block_start:block),brake(block_start:block),'g','linewidth',2,'marker','o','MarkerIndices',1:10:block);
ylabel('刹车(%)');   % 纵坐标标签
set(gca,'ylim',[0 3.5]);
yyaxis left 
